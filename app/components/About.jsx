...
import profilePic from "../../public/homeimg.png";
                    ...
                    <div className="relative h-[540px] bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md text-center cursor-pointer hover:scale-105 hover:shadow-2xl duration-700">
                        <div className="flex justify-center">
                            <Image
                                src={profilePic}
                                alt="Riyan Ghouri"
                                className="rounded-[90px] hover:scale-105 hover:shadow-2xl duration-700"
                                width={150}
                                height={150}
                            />
                        </div>
                        <h2 className="text-xl font-bold m-3">Riyan Ghouri</h2>
                        ...
                        <ul className="text-center text-sm space-y-3 flex-col flex gap-2">
                            <li className="flex items-center gap-2">
                                ...
                                <span><strong>Name:</strong> Riyan Ghouri</span>
                            </li>
                            <li className="flex items-center gap-2">
                            ...
                            <li className="flex items-center gap-2">
                                ...
                                <span><strong>Email:</strong> riyanghouri7@gmail.com</span>
                            </li>
                            <li className="flex items-center gap-2">
                                <FaPhone className="text-blue-500" />
                                <span><strong>Phone:</strong> +92 307-2555389</span>
                            </li>
                        </ul>
                        <a
                            download="/Riyan Ghouri.pdf"
                            href="/Riyan Ghouri.pdf"
                            className="cursor-pointer mt-4 inline-flex items-center justify-center gap-2 bg-blue-600 text-white font-semibold hover:scale-105 py-2 px-4 rounded-lg hover:bg-blue-700">
                    ...
                    <div className="md:col-span-2">
                        <div className="flex flex-col md:flex-row gap-6">
                            ...
                            <div className="w-full">
                                <h3 className="text-2xl font-semibold mx-4">Work Experience</h3>
                            ...
                            <div className="w-full">
                                ...
                                <div className="p-4 flex-col flex gap-5">
                                    {[
                                        ...
                                        { degree: "ICS", school: "Punjab College HSP", years: "|2018 - 2020|" },
                                        { degree: "Matric", school: "Punjab College HSP", years: "|2014 - 2016|" }
                                    ].map((edu, i) => (
