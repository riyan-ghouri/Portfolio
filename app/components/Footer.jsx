...
const social = [
  { href: "https://github.com/riyanghouri786", Icon: FaGithub, hover: "hover:text-blue-500" },
  { href: "https://www.linkedin.com/in/riyanghouri", Icon: FaLinkedin, hover: "hover:text-blue-500" },
];
    ...
    <footer className="bg-gray-100 text-gray-900 py-6 dark:bg-gray-900 dark:text-white">
      ...
      <div className="w-full flex flex-col sm:flex-row justify-between items-center gap-4 px-4 text-center">
        ...
        <p className="text-sm text-gray-400 ">
          © {new Date().getFullYear()} Riyan&nbsp;— All Rights Reserved
        </p>
