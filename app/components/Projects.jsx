...
import downloader from "../../public/downloader.png";
...
const projectData = [
  ...
  },
  {
    ...
    description:
      "Download YouTube video thumbnails in HD for free. Paste a link, grab the image — no watermark, no login.",
    image: downloader,
    languages: ["Next.js", "Tailwind CSS", "YouTube API"],
    liveDemo: "https://thumbnail-downloader-pi.vercel.app/",
    category: "Web",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    title: "Web Wallet",
    description:
      "Manage, send & store cryptocurrencies securely with an easy-to-use interface.",
    image: wallet,
    languages: ["Next.js", "Tailwind CSS", "JavaScript", "IOTA SDK"],
    liveDemo: "https://web-wallet-iota-azure.vercel.app/",
    category: "Web",
  },
];
            ...
            {projectsWithClones.length > 0 && (
              ...
              >
                {projectsWithClones.map((project, idx) => (
                  <div
                    key={`${project.id}-${idx}-${Math.random()}`} // ✅ Unique key per render
