...
const Contact = () => {
  ...
  const handleSendMessage = (e) => {
    ...
    const whatsappURL = `https://wa.me/923072555389?text=${fullMessage}`;
        ...
        <div className="flex flex-col justify-center space-y-6 px-4 md:px-0">
          <div>
            ...
            <p className="flex items-center gap-2 text-gray-700 mb-2 hover:scale-105 duration-700 dark:text-white">
              <FiMail className="text-blue-600" /> riyanghouri7@gmail.com
            </p>
            <p className="flex items-center gap-2 text-gray-700 mb-2 hover:scale-105 duration-700 dark:text-white">
              <FiPhone className="text-blue-600" /> +92 307-2555389
            </p>
