            ...
            <div className="flex flex-col-reverse md:flex-row items-center gap-10 sm:gap-50 max-w-7xl mx-auto">
                ...
                <div className="text-center md:text-left max-w-xl">
                    <h1 className="text-4xl sm:text-5xl font-bold leading-tight">
                        Hi, I'm <span className="text-blue-600">Riyan Ghouri</span>
                    </h1>
                ...
                <div className="w-65 h-70 sm:w-80 sm:h-90 rounded-xl overflow-hidden shadow-lg border-4 border-white dark:border-gray-800 hover:scale-110 duration-500">
                    <Image src={homeimg} alt="Riyan Profile" className="object-cover w-full h-full cursor-pointer" />
                </div>
            </div>
        </section>
    )
